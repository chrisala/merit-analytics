...
join_by_service_target_measures_and_aggregate <- 
  function(Data,service,
    ...
    fred <- Data %>%
      ...
      left_join(project_services,by=c("merit_project_id","service","target_measure",
...
Report_Raw <- bind_rows(
  ...
  sub_category_extract_context_no_species(
    ...
    actual=area_ha_treated_for_pest_animals,
    invoiced=invoiced_area_ha_length_km_treated_for_pest_animals,
  ...
  sub_category_extract_context_no_species(
    ...
    target_measure = "Area (ha) treated for pest animals - initial",
    measured=site_calculated_area_ha,
    actual=actual_area_ha_treated_for_pest_animals,
    invoiced=area_invoiced_ha,
    category = initial_or_follow_up_control,
    context = treatment_objective,
    sub_category = 'Initial',
...
# has the value "Follow-up"
#
# The delivery against the target "Length (km) treated for weeds - initial" is calculated by: 
# Using the form / service "RLP Output Report Adjustment (Output Report Adjustment)” 
# and summing the field "Adjustment” 
# where the field "scoreId"
# has the value "cf1794d1-5d9b-410b-9092-372ebf691b96"
# Using the form / service "RLP Output Report (Removing weeds)” 
# and summing the field "lengthTreatedKm” 
# where the field "Initial or follow-up treatment"
# has the value "Initial"
# Using the form / service "State Intervention Progress Report (Removing weeds)” 
# and summing the field "lengthTreatedKm” 
# where the field "Initial or follow-up treatment"
# has the value "Initial"
# Using the form / service "Bushfires States Progress Report (Removing weeds)” 
# and summing the field "lengthTreatedKm” 
# where the field "Initial or follow-up treatment"
# has the value "Initial"
# Using the form / service "State Intervention Final Report (Removing weeds)” 
# and summing the field "lengthTreatedKm” 
# where the field "Initial or follow-up treatment" 
# has the value "Initial"
#
# The delivery against the target "Length (km) treated for weeds - follow-up" is calculated by: 
# Using the form / service "RLP Output Report Adjustment (Output Report Adjustment)” 
# and summing the field "Adjustment” 
# where the field "scoreId" 
# has the value "14230564-70c2-47e6-9e75-ddc407fc9916"
# Using the form / service "RLP Output Report (Removing weeds)” 
# and summing the field "lengthTreatedKm” 
# where the field "Initial or follow-up treatment" 
# has the value "Follow-up"
...
Report_Raw <- bind_rows(
  ...
  sub_category_extract_context_species(
    ...
    target_measure = "Length (km) treated for weeds - initial",
    measured = site_calculated_length_km,
    invoiced = length_invoiced_km,
    actual = length_km_treated_for_weed_removal,
    category = initial_or_follow_up_treatment,
    sub_category = 'Initial',
    context=treatment_objective,
  ...
  sub_category_extract_context_species(
    ...
    worksheet = 'RLP - Weed treatm...tput Report',
    service = "Removing weeds",
    target_measure = "Length (km) treated for weeds - follow-up",
    measured = site_calculated_length_km,
    invoiced = length_invoiced_km,
    actual = length_km_treated_for_weed_removal,
    category = initial_or_follow_up_treatment,
...
Report_Raw <- bind_rows(
  ...
  sub_category_extract_context_species(
    ...
    measured=site_calculated_area_ha,
    actual=area_ha_of_habitat_revegetated,
    invoiced=invoiced_area_ha_of_habitat_revegetated,
  ...
  sub_category_extract_context_species(
    ...
    target_measure = "Area (ha) of revegetated habitat maintained",
    measured=site_calculated_area_ha,
    actual=actual_area_ha_length_km_of_habitat_revegetated,
    invoiced=area_invoiced_ha,
    context = planting_method,
    category = initial_or_maintenance_activity,
    sub_category = 'Maintenance',
...
#
# The delivery against the target "Area (ha) surveyed for weeds" is calculated by: 
# Using the form / service "RLP Output Report Adjustment (Output Report Adjustment)” 
# and summing the field "Adjustment” 
# where the field "scoreId" has the value "40bf706c-5337-486f-8006-3def00262984"
# Using the form / service "RLP Output Report (Weed distribution survey)” 
# and summing the field "Actual area (ha) surveyed for weed distribution"
# Using the form / service "State Intervention Progress Report (Weed distribution survey)” 
# and summing the field "Actual area (ha) surveyed for weed distribution"
# Using the form / service "Bushfires States Progress Report (Weed distribution survey)” 
# and summing the field "Actual area (ha) surveyed for weed distribution"
# Using the form / service "State Intervention Final Report (Weed distribution survey)” 
# and summing the field "Actual area (ha) surveyed for weed distribution"
#
# The delivery against the target "Number of weed distribution surveys conducted" is calculated by: 
# Using the form / service "RLP Output Report Adjustment (Output Report Adjustment)” 
# and summing the field "Adjustment” 
# where the field "scoreId" has the value "956a8ed6-a8ed-45ee-96cc-17fc9efc216a"
# Using the form / service "RLP Output Report (Weed distribution survey)” 
# and summing the field "Number of weed distribution surveys conducted"
# Using the form / service "State Intervention Progress Report (Weed distribution survey)” 
# and summing the field "Number of weed distribution surveys conducted"
# Using the form / service "Bushfires States Progress Report (Weed distribution survey)” 
# and summing the field "Number of weed distribution surveys conducted"
...
projects_reports <- 
  ...
  filter(!is.na(measured) & measured != 0 | !is.na(actual) & actual != 0 | !is.na(invoiced) & invoiced != 0) %>%
...
projects_services_targets_outcomes <- 
  read.xlsx(paste('M01 ',extract_date,'.xlsx',sep=''),sheet='Project services and targets') %>%
  clean_names() %>% 
  rename(merit_project_id=grant_id) %>%
